...
![WhatsApp Image 2025-10-28 at 00 01 49_17ab40d4](https://github.com/user-attachments/assets/ccbac8d2-843d-4fbe-8531-cad1d3f3429f)
...
```
<img width="1400" height="682" alt="{6A301236-8AA9-4190-B707-48CB52DA5258}" src="https://github.com/user-attachments/assets/79726adc-801f-4b7c-8576-c10f5d441aeb" />
...
<img width="816" height="34" alt="{7491AE9D-F3B5-4EBB-9D63-3708E83060F3}" src="https://github.com/user-attachments/assets/f51f523e-38c5-49fd-9d85-a3cbd12356a9" />
...
```bash
java -jar StegExpose.jar "C:\Users\archa\StegExpose\testFolder"
```
...
```bash
java -jar StegExpose.jar "C:\Users\archa\StegExpose\testFolder" fast 0.3 results.csv
